...
import { Layers, Presentation, Upload, FileText, GraduationCap, Workflow, Settings, Sun, Moon } from 'lucide-react';
...
const tools = [
  ...
  { id: 'luate' as const, name: 'Netral Luate', description: 'Create exercises and quizzes for education', icon: GraduationCap, gradient: 'from-amber-500 to-amber-600', shadow: 'shadow-amber-500/20', comingSoon: true },
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 sm:p-6 relative">
      ...
      <div className="max-w-2xl w-full">
        ...
        {/* Drag & Drop */}
        <input ref={fileInputRef} type="file" accept=".netblock,.netdeck,.netdoc,.txt" onChange={handleFileInput} className="hidden" />
        <button
